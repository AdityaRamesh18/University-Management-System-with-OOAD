 ...
 */
public class modifyStudentInfo extends javax.swing.JFrame {

    /**
     * Creates new form modifyStudentInfo
     */
    ...
    */
    ...
    private void initComponents() {
        ...
        classification_combo_box = new javax.swing.JComboBox<>();
        ...
        charges_text_field = new javax.swing.JFormattedTextField();
        ...
        modifyStudentInfo_MenuBar = new javax.swing.JMenuBar();
        ...
        classification_label.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        classification_label.setText("Classification:");

        classification_combo_box.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Freshman", "Sophmore", "Junior", "Senior", "Alumnus" }));
        classification_combo_box.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        charges_label.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        charges_label.setText("Charges:");

        charges_text_field.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("##,##0.00"))));
        charges_text_field.setToolTipText("Range: 0.00-99999.00");
                    ...
                    .addGroup(student_info_formLayout.createSequentialGroup()
                        .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(student_info_formLayout.createSequentialGroup()
                                    .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(classification_label)
                                    ...
                                    .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(classification_combo_box, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(student_info_formLayout.createSequentialGroup()
                                .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(student_info_formLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(degree_type_combo_box, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 233, Short.MAX_VALUE)
                        .addComponent(student_info_scroll_pane, javax.swing.GroupLayout.PREFERRED_SIZE, 780, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(21, 21, 21))
                    .addGroup(student_info_formLayout.createSequentialGroup()
                        .addGap(86, 86, 86)
                        .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(address_text_field, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                            .addComponent(email_text_field, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                            .addComponent(charges_text_field, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
                        ...
                        .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(student_info_formLayout.createSequentialGroup()
                                ...
                                .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(password_text_field, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(student_info_formLayout.createSequentialGroup()
        ...
        student_info_formLayout.setVerticalGroup(
            ...
            .addGroup(student_info_formLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(student_info_scroll_pane, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(student_info_formLayout.createSequentialGroup()
                ...
                .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(charges_label)
                    .addComponent(charges_text_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(student_info_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(phone_label)
        ...
        jScrollPane1.setViewportView(student_info_form);
        ...
        modifyStudentInfo_MenuBar.add(backButton);
        ...
        modifyStudentInfo_MenuBar.add(logoutButton);

        setJMenuBar(modifyStudentInfo_MenuBar);
        ...
        else
        {
            try
            {
                ...
                pst = conn.prepareStatement("insert into student(prefix, fName, mName, lName, "
                                         ...
                                         + "degreeName, degreeType, address, charges, telNo) "
                                         + "values(?,?,?,?,?,?,?,?,?,?,"
                                         + "?,?,?,?,?,?,?,?,?)");
                ...
                pst.setString(13, classification_combo_box.getSelectedItem().toString());
                ...
                pst.setString(18, charges_text_field.getText());
                pst.setString(19, phone_text_field.getText());
                pst.executeUpdate();
            
                /*
                Confirm to the admin that a new student has been added to the database
                and clear the form.
                */
                ...
                classification_combo_box.setSelectedIndex(0);
        ...
        else
        {
            try
            {
                ...
                pst = conn.prepareStatement("update student set prefix = ?, fName = ?, "
                                          ...
                                          + "degreeName = ?, degreeType = ?, address = ?, "
                                          + "charges = ?, telNo = ? where stuID = ?");
                pst.setString(1, prefix_combo_box.getSelectedItem().toString());
                pst.setString(2, fName_text_field.getText());
                pst.setString(3, mName_text_field.getText());
                pst.setString(4, lName_text_field.getText());
                ...
                /*
                Confirm to the admin that the selected student's info has been updated,
                clear the form, and reload each student's info.
                */
                JOptionPane.showMessageDialog(this, "Student's info is updated.");
    ...
    private void deleteButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteButtonMouseClicked
        try
        {
            ...
            // Delete the selected student's info from both the database and the table.
            pst = conn.prepareStatement("delete from student where stuID = ?");
            pst.setString(1, dtm.getValueAt(selectedIndex, 0).toString());
            pst.executeUpdate();
            
            /* Confirm to the admin that the selected student's info has been deleted,
               clear the form, and reload the remaining students' info.
            */
            JOptionPane.showMessageDialog(this, "Student's info is deleted.");
            insertButton.setEnabled(true); // Enables the Insert button
            prefix_combo_box.setSelectedIndex(0);
            fName_text_field.setText("");
            mName_text_field.setText("");
    ...
    private void degree_combo_boxMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_degree_combo_boxMouseClicked
        try
        {
            ...
            pst = conn.prepareStatement("select distinct name from degree where college = ?");
            pst.setString(1, college_combo_box.getSelectedItem().toString());
            rs = pst.executeQuery();
    ...
    private void student_info_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_student_info_tableMouseClicked
        ...
        classification_combo_box.setSelectedItem(dtm.getValueAt(selectedIndex, 9));
        degree_type_combo_box.setSelectedItem(dtm.getValueAt(selectedIndex, 10));
        degree_combo_box.setSelectedItem(dtm.getValueAt(selectedIndex, 11).toString());
        ...
        college_combo_box.setSelectedItem(dtm.getValueAt(selectedIndex, 18));
        charges_text_field.setText(dtm.getValueAt(selectedIndex, 19).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modifyStudentInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JFormattedTextField charges_text_field;
    private javax.swing.JComboBox<String> classification_combo_box;
    ...
    private javax.swing.JMenuBar modifyStudentInfo_MenuBar;
